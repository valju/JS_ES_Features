...
* Select the best answer -type questions (radio buttons)
* Select all that apply -type questions (checkboxes)
...
* if the task does not tell how many to select in "select all that apply" it can _rarely_ be 0, _rarely_ be all,
